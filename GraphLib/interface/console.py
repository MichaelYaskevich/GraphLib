...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description=f'Use algorithms from console.\nYou can provide algorithm with graph in txt file in the next format: \n{graph_file_format}',
    ...
    algorithms_all_paths = {'dijkstra': dijkstra.find_shortest_paths,
    ...
    algorithms_single_path = {'dijkstra': dijkstra.find_shortest_path,
