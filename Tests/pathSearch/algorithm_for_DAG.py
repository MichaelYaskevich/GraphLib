...
class Algorithm_for_DAG(unittest.TestCase):
    ...
    def test_shortest_paths_for_dag(self):
        find_shortest_paths_test(make_graph(), 'a',
                            {'a': 0, 'b': 1, 'c': 3},
                            {'a': None, 'b': 'a', 'c': 'b'})
        find_shortest_paths_test(make_graph1(), 1,
                            {1: 0, 2: 4, 3: 4, 4: 11},
                            {1: None, 2: 3, 3: 1, 4: 3})
        find_shortest_paths_test(make_graph2(), 1,
                            {1: 0, 2: 10, 3: 50, 4: 30, 5: 60},
                            {1: None, 2: 1, 3: 4, 4: 1, 5: 3})
        find_shortest_paths_test(make_graph3(), 1,
                                 {1: 0, 2: 12, 3: 24, 4: 36, 5: 12, 6: 30, 7: 56},
                                 {1: None, 2: 1, 3: 2, 4: 3, 5: 1, 6: 1, 7: 4})
        find_shortest_paths_test(make_graph4(), 1,
...
def find_shortest_paths_test(graph, source, expected_dist, expected_previous):
